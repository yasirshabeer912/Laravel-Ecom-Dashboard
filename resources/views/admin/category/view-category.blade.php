                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @if ($item->status==1)    
                                    <a href="{{url('admin/edit-category/status/0/'.$item->id)}}" class="btn btn-success">Active</a>
                                    @elseif ($item->status==0)
                                    <a href="{{url('admin/edit-category/status/1/'.$item->id)}}" class="btn btn-warning">Deactive</a>
                                    @endif
